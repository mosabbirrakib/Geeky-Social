...
<head>
    ...
    <title>What We Are | Geeky Social</title>
    <!--global css starts-->
...
<body>
        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="hidden-xs">
                    ...
                    <a href="{{ route('what_we_are') }}">What We Are</a>
                </li>
            </ol>
            <div class="pull-right">
                <i class="livicon icon3" data-name="users" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> What We Are
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row what_we_are">
            <!-- Left Heading Section Start -->
            <div class="col-md-7 col-sm-12">
                <p>
                    {{ $settings->what_we_are }}
                </p>
            </div>
            ...
            <div class="col-md-5 col-sm-12 slider">
                <div id="owl-demo" class="owl-carousel owl-theme">
                    <div class="item"><img src="{{ asset('uploads/what_we_are/'.$settings->what_we_are_pic) }}" alt="slider-image" style="height:230px; width:465px;">
                    </div>
                </div>
            </div>
            <!-- //Slider End -->

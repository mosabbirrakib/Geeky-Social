		...
		<div class="row">
			<div class="col-md-10">
				<div class="well well-sm">
					<a href="{{ route('admin.dashboard') }}"><i class="glyphicon glyphicon-home"></i></a>
					<a href="{{ route('logout') }}"><i class="glyphicon glyphicon-log-out"></i></a>
					<div class="row">
						<div class="col-sm-6 col-md-4">
							@if($users->avatar > 0)
							<img src="{{ asset('uploads/profile_pic/'.$users->avatar) }}" alt="avatar" class="img-rounded img-responsive" />
							@else
							<img src="{{ asset('uploads/profile_pic/default.jpg') }}" alt="avatar" class="img-rounded img-responsive">
							@endif
						...
						<div class="col-sm-6 col-md-8">
							...
							<div class="btn-group">
								<h3>Edit Profile</h3>
								<form action="{{ route('admin.update',$users->id) }}" method="POST"enctype="multipart/form-data" class="myform">
									@csrf
